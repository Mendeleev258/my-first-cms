          ...
          <li>
            ...
            <select name="categoryId" id="categoryId" required>
              ...
              <?php foreach ( $results['categories'] as $category ) { ?>
                <option value="<?php echo $category->id?>" <?php echo ( $category->id == $results['subcategory']->categoryId ) ? 'selected="selected"' : ''?>><?php echo htmlspecialchars( $category->name )?></option>
              <?php } ?>
            </select>
          </li>
