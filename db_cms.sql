...
-- Добавление столбца active в таблицу articles, если он не существует (для совместимости)
...
SET @sql = IF(@column_exists = 0,
              ...
              'SELECT "Column active already exists in articles table" as message');

PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

-- Dump completed on 2025-12-10  0:24:34
